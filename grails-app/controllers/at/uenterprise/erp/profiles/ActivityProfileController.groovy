...
class ActivityProfileController {
  ...
  */
  ...
  def removeEducator = {
    ...
    render template: 'educators', model: [educators: breaking.sources, activity: breaking.target]
  }
  ...
  def removeClient = {
    ...
    render template: 'clients', model: [clients: breaking.sources, activity: breaking.target]
  }
