...
class ParentProfileController {
  ...
  def del = {
    ...
    if (parent) {
      ...
      try {
        flash.message = message(code: "parent.deleted", args: [parent.profile.lastName + " " + parent.profile.firstName])
        parent.delete(flush: true)
        redirect(action: "list")
      }
      catch (org.springframework.dao.DataIntegrityViolationException e) {
        flash.message = message(code: "parent.notDeleted", args: [parent.profile.lastName + " " + parent.profile.firstName])
  ...
  def update = {
    ...
    if (!parent.profile.hasErrors() && parent.profile.save()) {
      flash.message = message(code: "parent.updated", args: [parent.profile.lastName + " " + parent.profile.firstName])
  ...
  def save = {
    ...
    try {
      ...
      flash.message = message(code: "parent.created", args: [entity.profile.lastName + " " + entity.profile.firstName])
      redirect action: 'list'
