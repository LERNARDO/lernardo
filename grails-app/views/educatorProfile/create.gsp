        ...
        <table>
          <tbody>         
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">
                    <input class="${hasErrors(bean:educator,field:'user.email','errors')}" size="40" type="text" maxlength="80" id="email" name="email" value="${fieldValue(bean:educator, field:'user.email')}"/>
                </td>
            </tr>
