      ...
      <div class="dialog">
 		<table>
		  ...
		  <tr>
			...
			<td width="120"  valign="middle"  class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.title', 'errors')}" size="15"  id="title" name="title" value="${fieldValue(bean: educator, field: 'profile.title').decodeHTML()}"/>
            </td>
			<td width="180"  valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.firstName', 'errors')}" size="25"  id="firstName" name="firstName" value="${fieldValue(bean: educator, field: 'profile.firstName').decodeHTML()}"/>
            </td>
			<td   width="200"  valign="middle"  class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.lastName', 'errors')}" size="27" maxlength="30" id="lastName" name="lastName" value="${fieldValue(bean: educator, field: 'profile.lastName').decodeHTML()}"/>
            </td>
		...
		<tr>
			<td valign="top" class="value">
              <g:textArea rows="3" cols="39" class="countable2000 ${hasErrors(bean: educator, field: 'profile.interests', 'errors')}" id="interests" size="42" name="interests" value="${fieldValue(bean: educator, field: 'profile.interests').decodeHTML()}"/>
            </td>
			<td valign="top" class="value">
		...
		<tr>
			<td width="280" height="35" valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.currentStreet', 'errors')}" size="41" id="currentStreet" name="currentStreet" value="${fieldValue(bean: educator, field: 'profile.currentStreet').decodeHTML()}"/>
            </td>
			...
			<td width="210" valign="middle"  class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.currentCity', 'errors')}" size="30" id="currentCity" name="currentCity" value="${fieldValue(bean: educator, field: 'profile.currentCity').decodeHTML()}"/>
            </td>
			<td  valign="middle"  class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.currentCountry', 'errors')}" size="30" id="currentCountry" name="currentCountry" value="${fieldValue(bean: educator, field: 'profile.currentCountry').decodeHTML()}"/>
            </td>
		...
		<tr>
			<td width="280" height="35" valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.originStreet', 'errors')}" size="41" id="originStreet" name="originStreet" value="${fieldValue(bean: educator, field: 'profile.originStreet').decodeHTML()}"/>
            </td>
			<td width="105"  valign="middle" class="value">
			...
			<td width=",210"  valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.originCity', 'errors')}" size="30" id="originCity" name="originCity" value="${fieldValue(bean: educator, field: 'profile.originCity').decodeHTML()}"/>
            </td>
			<td valign="middle" class="value">
              <g:if test="${RequestContextUtils.getLocale(request).toString() == 'es' || RequestContextUtils.getLocale(request).toString() == 'es_ES'}">
		...
		<tr>
			<td width="280" height="35" valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.contactStreet', 'errors')}" size="41" id="contactStreet" name="contactStreet" value="${fieldValue(bean: educator, field: 'profile.contactStreet').decodeHTML()}"/>
            </td>
			<td width="105"  valign="middle" class="value">
			...
			<td width="210"  valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.contactCity', 'errors')}" size="30" id="contactCity" name="contactCity" value="${fieldValue(bean: educator, field: 'profile.contactCity').decodeHTML()}"/>
            </td>
			<td valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.contactCountry', 'errors')}" size="30" id="contactCountry" name="contactCountry" value="${fieldValue(bean: educator, field: 'profile.contactCountry').decodeHTML()}"/>
            </td>
		 </tr>		
		</table>	
		...
		<tr>
			<td width="280" height="35" valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.contactPhone', 'errors')}" size="41" id="contactPhone" name="contactPhone" value="${fieldValue(bean: educator, field: 'profile.contactPhone').decodeHTML()}"/>
            </td>	
			<td valign="middle" class="value">
              <g:textField class="countable50 ${hasErrors(bean: educator, field: 'profile.contactMail', 'errors')}" size="47" id="contactMail" name="contactMail" value="${fieldValue(bean: educator, field: 'profile.contactMail').decodeHTML()}"/>
            </td>	
		</tr>
		</table>
		</div>
