    ...
    <g:form id="${educator.id}">
      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td class="value">
            <g:textArea rows="5" cols="50" data-counter="2000" class="${hasErrors(bean: educator, field: 'profile.interests', 'errors')}" name="interests" value="${fieldValue(bean: educator, field: 'profile.interests').decodeHTML()}"/>
          </td>
        </tr>
        ...
        <table width="100%">
          <tr>
            ...
            <td>
              ...
              <g:textField class="${hasErrors(bean: educator, field: 'user.email', 'errors')}" required="" size="30" type="text" maxlength="80" name="email" value="${fieldValue(bean: educator, field: 'user.email')}"/>
            </td>
            <td>
      ...
      <div class="buttons cleared">
        ...
        <div class="button"><g:link class="buttonGray" action="show" id="${educator.id}"><g:message code="cancel"/></g:link></div>
      </div>
