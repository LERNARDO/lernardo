<g:if test="${results}">
  <div class="remoteresults" style="width:635px">
    <g:each in="${results}" var="entity">
      <g:remoteLink url="[controller:'projectProfile', action:'addSubstitute', id:projectDay, params:[substitute: entity.id]]" update="substitutes2" before="showspinner('#substitutes2')">
