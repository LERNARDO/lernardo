  ...
  <ul>
    <g:each in="${units}" var="unit" status="i">
      <li style="border-bottom: 1px solid #ccc; margin-bottom: 5px">
        ...
        <p class="bold"><g:message code="parents"/> <erp:accessCheck entity="${entity}" types="['Betreiber']" creatorof="${project}"><a onclick="toggle('#parents${i}'); return false" href="#"><img src="${g.resource(dir:'images/icons', file:'icon_add.png')}" alt="Erziehungsberechtigten hinzufügen" /></a></erp:accessCheck></p>
        ...
        <p class="bold"><g:message code="partners"/> <erp:accessCheck entity="${entity}" types="['Betreiber']" creatorof="${project}"><a onclick="toggle('#partners${i}'); return false" href="#"><img src="${g.resource(dir:'images/icons', file:'icon_add.png')}" alt="Partner hinzufügen" /></a></erp:accessCheck></p>
