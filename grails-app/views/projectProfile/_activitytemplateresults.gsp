<g:if test="${results}">
  <div class="remoteresults" style="width:635px">
    <g:each in="${results}" var="entity">
      <g:remoteLink url="[controller: 'projectProfile', action: 'addActivityTemplate', id: projectUnitID, params: [activityTemplate: entity.id, i: i, project: project]]" update="activities2-${i}" before="showspinner('#activities2-${i}'); toggle('#activities${i}');">
