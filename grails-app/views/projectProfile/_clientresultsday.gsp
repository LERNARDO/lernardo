<g:if test="${results}">
  <div class="remoteresults">
    <g:each in="${results}" var="entity">
      <g:remoteLink url="[controller: 'projectProfile', action: 'addClientDay', id: group, params: [client: entity.id, day: projectDay.id]]" update="clients2" before="showspinner('#clients2'); toggle('#clients');">
