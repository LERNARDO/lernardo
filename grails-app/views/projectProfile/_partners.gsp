...
<g:else>
  <span class="italic">Bitte die Partner auswählen, die an dieser Projekteinheit teilnehmen%{--Keine Partner zugewiesen--}% <img src="${g.resource(dir:'images/icons', file:'icon_warning.png')}" alt="Achtung" align="top"/></span>
</g:else>