  ...
  <div class="yui-b">
    <div id="profile-content">
      <table width="100%">
        ...
        <tr><td class="bold titles bezeichnung">Telefon:</td><td class="bezeichnung">${profileInstance.telefon}</td></tr>
        <tr><td class="bold titles bezeichnung">Ansprechperson:</td><td class="bezeichnung">${profileInstance.ansprechperson}</td></tr>
        <tr><td class="bold titles bezeichnung">Öffnungszeiten:</td><td class="bezeichnung">${profileInstance.oeffnungszeiten}</td></tr>
        <tr><td class="bold titles bezeichnung">Beschreibung:</td><td class="bezeichnung">${profileInstance.beschreibung}</td></tr>
      </table>
%{--<g:form>
