<div class="zusatz">
  ...
  <div class="linkstabs">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Pädagoge','Einrichtung','Betreuter','Partner','Erziehungsberechtigter']">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Einrichtung','Betreuter','Pädagoge']">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Erziehungsberechtigter','Betreuter','Kind']">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Einrichtung','Partner']">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Betreuter','Pädagoge']">
    ...
    <erp:accessCheck entity="${entity}" roles="[]" types="['Partner']">
