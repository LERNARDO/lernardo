...
<div class="boxGray">
  <div class="second">
    ...
    <div id="remoteEvaluations">
      <g:if test="${show}">
        <g:render template="someevaluations" model="[evaluationInstanceList: evaluations, totalEvaluations: totalEvaluations, entity: entity, currentEntity: currentEntity]"/>
      </g:if>
    </div>
