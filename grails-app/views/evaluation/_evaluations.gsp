...
<div class="paginateButtons">
  <util:remotePaginate action="showall" total="${totalEvaluations}" update="remoteEvaluations" next="${message(code:'page.next')}" prev="${message(code:'page.prev')}" id="${entity.id}"/>
</div>