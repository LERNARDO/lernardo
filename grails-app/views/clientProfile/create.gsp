                  ...
                  <td  valign="top" class="value ${hasErrors(bean: client, field: 'profile.job', 'errors')}">
                   ...
                   <tr>
                     ...
                     <td colspan="3" valign="top" class="value">
                        <g:textField class="countable500 ${hasErrors(bean: client, field: 'profile.supportDescription', 'errors')}" size="30" id="supportDescription" name="supportDescription" value="${client?.profile?.supportDescription?.toInteger()}"/>
                      </td>
                    </tr>
