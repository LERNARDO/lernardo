    ...
    <g:form action="update" method="post" id="${client.id}">
      <div class="dialog">
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value">
            <g:textField class="${hasErrors(bean: client, field: 'profile.PLZ', 'errors')}" size="30" id="PLZ" name="PLZ" value="${client?.profile?.PLZ?.toInteger()}"/>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value">
            <g:textField class="${hasErrors(bean: client, field: 'profile.PLZ2', 'errors')}" size="30" id="PLZ2" name="PLZ2" value="${client?.profile?.PLZ2?.toInteger()}"/>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value">
            <g:select class="${hasErrors(bean: parent, field: 'profile.languages', 'errors')}" multiple="true" name="languages" from="${['Deutsch', 'Englisch', 'Französisch', 'Spanisch', 'Portugiesisch']}"/>
          </td>
        </tr>
