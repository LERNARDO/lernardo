...
<head>
  ...
  <title><g:message code="object.edit" args="[message(code: 'client')]"/></title>
</head>
<body>
<div class="boxHeader">
  <h1><g:message code="object.edit" args="[message(code: 'client')]"/></h1>
</div>
      ...
      <div>
        ...
        <table>
          ...
          <tr class="prop">
            ...
            <td class="value">
              <g:textField data-counter="50" class="${hasErrors(bean: client, field: 'profile.firstName', 'errors')}" required="" size="40" name="firstName" value="${fieldValue(bean: client, field: 'profile.firstName').decodeHTML()}"/>
            </td>
          </tr>
        ...
        <table>
          ...
          <tr class="prop">
            ...
            <td class="value">
              <g:textField size="30" name="jobFrequency" value="${fieldValue(bean: client, field: 'profile.jobFrequency').decodeHTML()}"/>
            </td>
          </tr>
