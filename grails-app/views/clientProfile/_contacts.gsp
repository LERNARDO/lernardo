<g:if test="${client.profile.contacts}">
  <table>
    <g:each in="${client.profile.contacts}" var="representative">
      ...
      <tr class="prop">
        <td valign="top" class="italic"><g:message code="representantives.phone"/>:</td><td class="value" width="150">${representative.phone ?: '<div class="italic">'+message(code:'none')+'</div>'}</td>
        <td valign="top" class="italic" width="60"><g:message code="representantives.email"/>:</td><td class="value" width="160">${representative.email ?: '<div class="italic">'+message(code:'none')+'</div>'}</td>
        <td valign="top" class="italic" width="100"><g:message code="representantives.function"/>:</td><td class="value">${representative.function ?: '<div class="italic">'+message(code:'none')+'</div>'}</td>
      </tr>
