...
<div class="boxGray">
  <div class="second">
    ...
    <div class="zusatz">
      <h5><g:message code="client.profile.inOut" args="[grailsApplication.config.projectName]"/> <erp:accessCheck entity="${currentEntity}" types="['Betreiber','Pädagoge']"><a onclick="toggle('#dates');
