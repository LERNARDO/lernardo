...
<div class="boxGray">
  ...
  <g:form action="update" method="post" id="${postInstance.id}">
    ...
    <span class="${hasErrors(bean: postInstance, field: 'teaser', 'errors')}"><g:textArea class="countable${postInstance.constraints.teaser.maxSize}" name="teaser" rows="4" style="width: 100%" value="${fieldValue(bean:postInstance,field:'teaser').decodeHTML()}"/></span>
