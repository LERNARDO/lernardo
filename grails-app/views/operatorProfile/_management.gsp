...
<div class="zusatz">
    <h5><g:message code="facilities"/> <erp:accessCheck me="${operator}"><img onclick="toggle('#facilities');" src="${g.resource(dir:'images/icons', file:'bullet_arrow_toggle.png')}" alt="${message(code: 'add')}"/></erp:accessCheck></h5>
