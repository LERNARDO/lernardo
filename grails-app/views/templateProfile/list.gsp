      ...
      <g:formRemote name="formRemote0" url="[controller:'templateProfile', action:'updateselect']" update="searchresults" before="showspinner('#searchresults')">
        ...
        <table>
          ...
          <tr>
            ...
            <td><span class="gray"><g:message code="from"/></span> <g:textField name="ageFrom" size="5"/> <span class="gray"><g:message code="to"/></span> <g:textField name="ageTo" size="5"/></td>
          </tr>
          <tr>
            <td class="bold" valign="top" style="padding-right: 10px;"><g:message code="vMethod"/> 1:</td>
            <td>
          ...
          <tr>
            <td class="bold" valign="top"><g:message code="vMethod"/> 2:</td>
            <td>
          ...
          <tr>
            <td class="bold" valign="top"><g:message code="vMethod"/> 3:</td>
            <td>
