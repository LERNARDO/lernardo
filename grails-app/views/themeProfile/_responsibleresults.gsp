<g:if test="${results}">
  <div class="remoteresults">
    <g:each in="${results}" var="entity">
      <g:remoteLink url="[controller: 'themeProfile', action: 'addResponsible', id: themeID, params: [entity: entity.id]]" update="responsible2" before="showspinner('#responsible2'); toggle('#responsible');">
