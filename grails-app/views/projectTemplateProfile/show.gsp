...
<body>
<div class="boxHeader">
  <h1><erp:getFavorite entity="${projectTemplate}"/> ${fieldValue(bean: projectTemplate, field: 'profile.fullName').decodeHTML()} <span style="font-size: 12px;">(<g:message code="projectTemplate"/>)</span></h1>
</div>
...
<div class="boxGray">
  <div class="second">
    ...
    <div id="content">
      ...
      <p><g:message code="creator"/>: <span id="creator"><g:render template="/templates/creator" model="[entity: projectTemplate]"/></span> <erp:accessCheck roles="['ROLE_ADMIN']"><a onclick="toggle('#setcreator'); return false" href="#"><img src="${g.resource(dir: 'images/icons', file: 'bullet_arrow_toggle.png')}" alt="Ersteller ändern"/></a></erp:accessCheck></p>
