...
<table class="default-table">
  <thead>
  <tr>
    <util:remoteSortableColumn property="fullName" title="${message(code:'projectTemplate.profile.name')}" action="updateselect" update="templateselect" params="[name: name]"/>
