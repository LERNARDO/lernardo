        ...
        <table>
          ...
          <tr class="prop">
            <td width="540" valign="top" class="value">
              <g:textField class="countable50 ${hasErrors(bean: resource, field: 'profile.fullName', 'errors')}" size="80" id="fullName" name="fullName" value="${fieldValue(bean: resource, field: 'profile.fullName')}"/>
            </td>
          ...
          <tr class="prop">
            ...
            <tr>
              ...
              <g:textArea class="countable2000 ${hasErrors(bean: resource, field: 'profile.description', 'errors')}" id="description" rows="3" cols="120" name="description" value="${fieldValue(bean: resource, field: 'profile.description')}"/>
            </td>
          </tr>
