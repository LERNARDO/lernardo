...
<g:if test="${entity.profile.showTips}">
  <div class="toolTip">
    <div class="second">
      <b><img src="${resource(dir: 'images/icons', file: 'icon_template.png')}" alt="toolTip" align="top"/>Tipp:</b> Ereignisse geben dir einen Überblick über deine Termine und Tätigkeiten.
    </div>
  </div>
</g:if>
