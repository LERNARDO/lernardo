<html>
  <head>
    ...
    <title>Profil - Lernardo Mitarbeiter</title>
  </head>
  <body>
      ...
      <div id="bd">
        ...
        <div class="yui-b" id="profile-navigation">
          ...
          <g:render template="picturebox" model="[name:profileInstance.fullName+' - '+profileInstance.role,
                                                  type:'mitarbeiter', imageUrl:profileInstance.image]"/>
        ...
        <g:else>
          <g:render template="/templates/mitarbeiter-content-${content}" model="${profileInstance}" />
        </g:else>
      </div>
    </div>
