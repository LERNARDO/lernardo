      ...
      <div class="dialog">
        <table>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value">
              <g:textArea class="${hasErrors(bean: group, field: 'profile.livingConditions', 'errors')}" rows="5" cols="40" name="livingConditions" value="${fieldValue(bean: group, field: 'profile.livingConditions').decodeHTML()}"/>
            </td>
          </tr>
          ...
          <tr class="prop">
            ...
            <td valign="top" class="value">
              <g:textArea class="${hasErrors(bean: group, field: 'profile.socioeconomicData', 'errors')}" rows="5" cols="40" name="socioeconomicData" value="${fieldValue(bean: group, field: 'profile.socioeconomicData').decodeHTML()}"/>
            </td>
          </tr>
