      ...
      <div class="zusatz-add" id="clients" style="display:none">
        ...
        <g:formRemote name="formRemote0" url="[controller:'groupClientProfile', action:'updateselect']" update="clientselect">
          ...
          <table>
            ...
            <tr>
              <td>Geburtsdatum:</td>
              <td>zwischen <g:datePicker name="birthDate1" precision="year" years="${new Date().getYear()+1800..new Date().getYear()+1900}" noSelection="[null:'Alle']"/> und <g:datePicker name="birthDate2" precision="year" years="${new Date().getYear()+1800..new Date().getYear()+1901}" noSelection="[null:'Alle']"/></td>
            </tr>
            <tr>
              <td>Geschlecht:</td>
