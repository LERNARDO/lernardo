    ...
    <g:form>
      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td class="value">
            <g:textField data-counter="50" class="${hasErrors(bean: group, field: 'profile', 'errors')}" required="" size="30" name="fullName" value="${fieldValue(bean: group, field: 'profile').decodeHTML()}"/>
          </td>
        </tr>
