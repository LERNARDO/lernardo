<head>
  ...
  <title><g:message code="groupColony"/> - ${group.profile}</title>
</head>
<body>
<div class="boxHeader">
  <h1><erp:getFavorite entity="${group}"/> ${group.profile} <span style="font-size: 12px;">(<g:message code="groupColony"/>)</span></h1>
</div>
...
<div class="boxContent">
    ...
    <div class="tabnav">
      <ul>
        ...
        <li><g:remoteLink update="content" controller="groupColonyProfile" action="management" id="${group.id}" before="showspinner('#content');"><g:message code="management"/></g:remoteLink></li>
