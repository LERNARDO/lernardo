    ...
    <g:each in="${group.profile.representatives}" var="representative">
      <tr class="prop">
        ...
        <td><app:isOperator entity="${entity}">
          <g:remoteLink action="editRepresentative" update="representatives2" id="${group.id}" params="[representative: representative.id]" before="showspinner('#representatives2')"><img src="${g.resource(dir: 'images/icons', file: 'icon_edit.png')}" alt="Repräsentant bearbeiten" align="top"/></g:remoteLink>
          <g:remoteLink action="removeRepresentative" update="representatives2" id="${group.id}" params="[representative: representative.id]" before="if(!confirm('${message(code:'delete.warn')}')) return false"><img src="${g.resource(dir: 'images/icons', file: 'icon_remove.png')}" alt="Repräsentant entfernen" align="top"/></g:remoteLink>
