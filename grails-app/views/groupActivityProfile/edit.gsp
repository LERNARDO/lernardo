        ...
        <table>
          ...
          <tr>
            <td width="280px" valign="top" class="value">
              <g:textField data-counter="100" class="${hasErrors(bean: group, field: 'profile.fullName', 'errors')}" required="" size="40" name="fullName" value="${fieldValue(bean: group, field: 'profile.fullName')?.decodeHTML()}"/>
            </td>
