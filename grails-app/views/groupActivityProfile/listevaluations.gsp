...
<body>
<div class="boxHeader">
  <h1>Tagebucheinträge verknüpft mit ${entity.profile}</h1>
</div>
        ...
        <div class="leistung-item">
          <table cellpadding="2">
            <tr>
              ...
              <td><g:link controller="${evaluation.owner.type.supertype.name + 'Profile'}" action="show" id="${evaluation.owner.id}" params="[entity:evaluation.owner.id]">${evaluation.owner.profile.decodeHTML()}</g:link></td>
            </tr>
            <tr>
