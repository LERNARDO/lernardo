...
<div class="boxContent">
    ...
    <div class="tabnav">
      <ul>
        ...
        <li><g:remoteLink update="content" controller="groupActivityProfile" action="management" id="${group.id}" before="showspinner('#content');"><g:message code="management"/></g:remoteLink></li>
