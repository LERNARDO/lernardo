<g:formRemote name="myForm" url="[action:'updateContact', id:facility.id, params:[representative: representative.id]]" update="contacts2">
  ...
  <erp:accessCheck entity="${entity}" types="['Betreiber']"><g:submitButton name="button" value="${message(code:'change')}"/></erp:accessCheck>
  <div class="clear"></div>
</g:formRemote>
