    ...
    <g:each in="${facility.profile.contacts}" var="representative">
      <tr class="prop">
        ...
        <td><app:isOperator entity="${entity}">
          <g:remoteLink action="editContact" update="contacts2" id="${facility.id}" params="[contact: representative.id]" before="showspinner('#contacts2')"><img src="${g.resource(dir: 'images/icons', file: 'icon_edit.png')}" alt="Ansprechperson bearbeiten" align="top"/></g:remoteLink>
          <g:remoteLink action="removeContact" update="contacts2" id="${facility.id}" params="[contact: representative.id]" before="if(!confirm('${message(code:'delete.warn')}')) return false"><img src="${g.resource(dir: 'images/icons', file: 'icon_remove.png')}" alt="Ansprechperson entfernen" align="top"/></g:remoteLink>
...
<g:else>
  <span class="italic"><g:message code="contacts.empty"/> <img src="${g.resource(dir:'images/icons', file:'icon_warning.png')}" alt="Achtung" align="top"/></span>
</g:else>