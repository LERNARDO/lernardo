...
<head>
  <title>Lernardo ERP - Registrierung</title>
    ...
    <div id="registerbox">
      ...
      <form id="form1" name="form1" method="post" action="">
        <table width="100" border="0">
          ...
          <tr>
            <td><label><input type="submit" name="8" id="8" value="Abbruch" /></label></td>
            <td><label><input type="submit" name="9" id="9" value="Bestätigen" /></label></td>
          </tr>
        </table>
      </form>
    </div>
