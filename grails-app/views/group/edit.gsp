                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:groupInstance,field:'members','errors')}">
                                    <g:select name="members"
from="${de.uenterprise.ep.Entity.list()}"
size="5" multiple="yes" optionKey="id"
value="${groupInstance?.members}" />
