<table>
  <tr>
    <td style="padding-right: 20px;">
      ...
      <g:message code="from"/> <g:formatDate date="${routine.dateFrom}" format="HH:mm" timeZone="${TimeZone.getTimeZone(grailsApplication.config.timeZone.toString())}"/> Uhr bis <g:formatDate date="${routine.dateTo}" format="HH:mm" timeZone="${TimeZone.getTimeZone(grailsApplication.config.timeZone.toString())}"/> Uhr
    </td>
    <td valign="top">
      ${routine.description}
    </td>
